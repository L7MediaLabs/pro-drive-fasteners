        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 items-center max-w-[1200px] mx-auto">
          <div>
            ...
            <p className="mt-5" style={{ color: "var(--pd-dark)", fontSize: 16, lineHeight: 1.7, maxWidth: 560, opacity: 0.88 }}>
              Every Pro-Drive Fasteners® mallet handle is turned from <strong>100% hickory wood stock</strong> on a 100-year-old lathe. It's the kind of detail most manufacturers skip and most contractors feel the first time they swing one.
            </p>
